...
from paper_tran.arxiv_crawler.arxiv_time import next_arxiv_update_day
from paper_tran.arxiv_crawler.paper import Paper, PaperDatabase, PaperExporter
...
class ArxivScraper(object):
    ...
    def get_url(self, start):
        ...
        return (
            ...
            # f"https://arxiv.org/search/?order=-announced_date_first&size=50&query={arxiv_id}"
    ...
    def parse_search_html(self, content) -> list[Paper]:
        ...
        for result in results:
            ...
            # 提取 PDF 链接并构建完整 URL
            pdf_link_tag = result.find("a", string="pdf")  # 找到 PDF 下载链接
            pdf_link = pdf_link_tag['href'] if pdf_link_tag else "No PDF link"
...
if __name__ == "__main__":
    ...
    scraper = ArxivScraper(
        ...
        optional_keywords=["quantum", "condensate"],
    )
